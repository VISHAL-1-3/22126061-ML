...
h = X * theta;  % h is the predicted values

% Call the Evaluationmatrice function
[RMSE, MSE, AME, RMLSE, R2, R2adjusted] = Evaluationmatrice(h, y, X);

% Display the evaluation metrics
fprintf('Root Mean Squared Error (RMSE): %f\n', RMSE);
fprintf('Mean Squared Error (MSE): %f\n', MSE);
fprintf('Absolute Mean Error (AME): %f\n', AME);
fprintf('Root Mean Log Squared Error (RMLSE): %f\n', RMLSE);
fprintf('R-squared (R2): %f\n', R2);
fprintf('Adjusted R-squared (R2 Adjusted): %f\n', R2adjusted);
